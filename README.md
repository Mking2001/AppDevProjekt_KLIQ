...
### 3. Ausführen via Bash (Linux / macOS)
```bash
chmod +x scripts/run_main_workflow_ui_tests.sh
./scripts/run_main_workflow_ui_tests.sh
```

---

## Repository Dokumentation (Kapitel 9.2)
...
- [Pull Request Dokumentation](file:///c:/Users/kremidas/Documents/AppDevProjekt_KLIQ/PULL_REQUEST_9.2_UI_Tests_Main_Workflow.md)
- [QA Checkliste](file:///c:/Users/kremidas/Documents/AppDevProjekt_KLIQ/QA_Checklist_9.2_UI_Tests_Main_Workflow.md)
- [Test Szenario Manual](file:///c:/Users/kremidas/Documents/AppDevProjekt_KLIQ/TEST_SCENARIO_9.2_Main_Workflow.md)
- [Code Review & Technical Audit](file:///c:/Users/kremidas/Documents/AppDevProjekt_KLIQ/CODE_REVIEW_9.2_UI_Tests_Main_Workflow.md)
