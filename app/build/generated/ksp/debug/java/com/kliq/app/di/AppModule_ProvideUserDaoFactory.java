...
public final class AppModule_ProvideUserDaoFactory implements Factory<UserDao> {
  private final Provider<KliqDatabase> databaseProvider;

  public AppModule_ProvideUserDaoFactory(Provider<KliqDatabase> databaseProvider) {
  ...
  public static AppModule_ProvideUserDaoFactory create(Provider<KliqDatabase> databaseProvider) {
    return new AppModule_ProvideUserDaoFactory(databaseProvider);
  }

  public static UserDao provideUserDao(KliqDatabase database) {
