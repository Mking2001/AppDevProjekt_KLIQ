...
import com.kliq.app.di.AppModule_ProvideApiServiceFactory;
import com.kliq.app.di.AppModule_ProvideDatabaseFactory;
import com.kliq.app.di.AppModule_ProvideUserDaoFactory;
import com.kliq.app.ui.navigation.NavigationViewModel;
import com.kliq.app.ui.navigation.NavigationViewModel_HiltModules_KeyModule_ProvideFactory;
import com.kliq.app.ui.navigation.TopBarViewModel;
import com.kliq.app.ui.navigation.TopBarViewModel_HiltModules_KeyModule_ProvideFactory;
import com.kliq.app.ui.screens.chat.ChatDetailViewModel;
import com.kliq.app.ui.screens.chat.ChatDetailViewModel_HiltModules_KeyModule_ProvideFactory;
import com.kliq.app.ui.screens.chat.ChatListViewModel;
import com.kliq.app.ui.screens.chat.ChatListViewModel_HiltModules_KeyModule_ProvideFactory;
import com.kliq.app.ui.screens.club.ClubViewModel;
import com.kliq.app.ui.screens.club.ClubViewModel_HiltModules_KeyModule_ProvideFactory;
import com.kliq.app.ui.screens.explore.ExploreViewModel;
import com.kliq.app.ui.screens.explore.ExploreViewModel_HiltModules_KeyModule_ProvideFactory;
import com.kliq.app.ui.screens.home.HomeViewModel;
import com.kliq.app.ui.screens.home.HomeViewModel_HiltModules_KeyModule_ProvideFactory;
import com.kliq.app.ui.screens.map.MapViewModel;
import com.kliq.app.ui.screens.map.MapViewModel_HiltModules_KeyModule_ProvideFactory;
import com.kliq.app.ui.screens.notifications.NotificationsViewModel;
import com.kliq.app.ui.screens.notifications.NotificationsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerKliqApplication_HiltComponents_SingletonC {
  private DaggerKliqApplication_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public KliqApplication_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements KliqApplication_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public KliqApplication_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements KliqApplication_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public KliqApplication_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements KliqApplication_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public KliqApplication_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements KliqApplication_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public KliqApplication_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements KliqApplication_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public KliqApplication_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements KliqApplication_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public KliqApplication_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements KliqApplication_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public KliqApplication_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends KliqApplication_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends KliqApplication_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends KliqApplication_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends KliqApplication_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends KliqApplication_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.clubViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.kliq.app.ui.screens.chat.ChatDetailViewModel 
          return (T) new ChatDetailViewModel();

          case 1: // com.kliq.app.ui.screens.chat.ChatListViewModel 
          return (T) new ChatListViewModel();

          case 2: // com.kliq.app.ui.screens.club.ClubViewModel 
          return (T) new ClubViewModel();

          case 3: // com.kliq.app.ui.screens.explore.ExploreViewModel 
          return (T) new ExploreViewModel();

          case 4: // com.kliq.app.ui.screens.home.HomeViewModel 
          return (T) new HomeViewModel();

          case 5: // com.kliq.app.viewmodel.MainViewModel 
          return (T) new MainViewModel(singletonCImpl.userRepositoryProvider.get());

          case 6: // com.kliq.app.ui.screens.map.MapViewModel 
          return (T) new MapViewModel();

          case 7: // com.kliq.app.ui.navigation.NavigationViewModel 
          return (T) new NavigationViewModel();

          case 8: // com.kliq.app.ui.screens.notifications.NotificationsViewModel 
  ...
  private static final class ActivityRetainedCImpl extends KliqApplication_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends KliqApplication_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends KliqApplication_HiltComponents.SingletonC {
    private final ApplicationContextModule applicationContextModule;

    private final SingletonCImpl singletonCImpl = this;

    private Provider<KliqApiService> provideApiServiceProvider;

    private Provider<KliqDatabase> provideDatabaseProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideApiServiceProvider = DoubleCheck.provider(new SwitchingProvider<KliqApiService>(singletonCImpl, 1));
      this.provideDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<KliqDatabase>(singletonCImpl, 2));
      this.userRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<UserRepository>(singletonCImpl, 0));
    }

    @Override
    public void injectKliqApplication(KliqApplication kliqApplication) {
    }
