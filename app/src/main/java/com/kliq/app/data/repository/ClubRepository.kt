...
interface ClubRepository {
    ...
    fun searchClubsFiltered(query: String, regionFilter: String? = null, genreFilter: String? = null): Flow<List<Club>>
    fun searchRegionsAndCities(query: String): Flow<List<RegionSearchResult>>
